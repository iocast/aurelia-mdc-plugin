...
var MdcChip = exports.MdcChip = (_dec = (0, _aureliaFramework.customElement)('mdc-chip'), _dec2 = (0, _aureliaFramework.inject)(_aureliaFramework.DOM.Element), _dec3 = (0, _aureliaFramework.bindable)({
    defaultValue: false
}), _dec4 = (0, _aureliaFramework.bindable)({
    defaultValue: false
}), _dec5 = (0, _aureliaFramework.computedFrom)('remove'), _dec(_class = _dec2(_class = (_class2 = function () {
    ...
    return MdcChip;
}(), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'remove', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
