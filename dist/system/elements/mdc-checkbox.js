...
System.register(['aurelia-framework', 'material-components-web'], function (_export, _context) {
  ...
  var inject, bindable, bindingMode, DOM, checkbox, _dec, _dec2, _dec3, _dec4, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, MdcCheckbox;
  ...
  return {
    ...
    execute: function () {
      _export('MdcCheckbox', MdcCheckbox = (_dec = inject(DOM.Element), _dec2 = bindable({
