...
System.register(['aurelia-pal', './config', './mdc-target', './elements/mdc-datepicker', './elements/mdc-timepicker', './elements/mdc-autocomplete'], function (_export, _context) {
    "use strict";

    var PLATFORM, MdcConfig, MDC_TARGET_ATTR, MDC_INIT_ATTR, MDC_DISABLE_INIT_ATTR, MdcTarget, MdcDatepicker, MdcTimepicker, MdcAutocomplete, pluginConfig;
